        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#transaksi<?php echo $data_member['id_member']?>">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    ...
                    // $get_outlet = mysqli_query($conn, "SELECT * FROM user join outlet on outlet.id_outlet=user.id_outlet  where id_user = '" . $kasir['id_user'] . "'");

                    // $get_outlet = mysqli_query($conn, "SELECT * FROM outlet  JOIN user  ON outlet.id_outlet = user.id_user WHERE u.id_outlet ='".$_SESSION['id_outlet']."'");

                    // $get_outlet = mysqli_query($conn, "SELECT * FROM outlet JOIN user ON outlet.id_outlet = user.id_user where user.id_user ='".$_SESSION['id_user']."'");

                    //  $get_outlet = mysqli_query($conn, "SELECT o.id_outlet, o.nama_outlet FROM outlet o JOIN user u ON u.id_outlet=o.id_outlet WHERE '".@$_SESSION['id_user']."'");

                    // $get_outlet = mysqli_query($conn, "SELECT o.id_outlet, o.nama_outlet FROM outlet o JOIN user u ON u.id_user=o.id_outlet WHERE u.id_outlet");

                    $get_outlet = mysqli_query($conn," SELECT * FROM user INNER JOIN outlet USING (id_outlet) WHERE id_user ='".@$_SESSION['id_user']."' ");
