...
<div class="row">   
        <?php
            ...
            if(isset($_POST['cari'])){
                $cari = $_POST['cari'];
                $qry_outlet=mysqli_query($conn, "SELECT o.id_outlet, o.nama_outlet, u.nama_user, o.alamat, o.telp FROM outlet o JOIN user u ON u.id_user=o.id_owner WHERE u.id_user = '$cari' or o.nama_outlet like '%$cari%' or u.nama_user like '%$cari%' or o.alamat like '%$cari%' or o.telp like '%$cari%'  ");
            }
            else{
                ...
                $qry_outlet = mysqli_query($conn, "SELECT o.id_outlet, o.nama_outlet, u.nama_user, o.alamat, o.telp FROM outlet o JOIN user u ON u.id_user=o.id_owner WHERE u.id_user ='".$_SESSION['id_user']."'");
            }
            $no = 0;
        ...
        ?>
            ...
            <tr>            
                ...
                <td><a href="ubah_outlet.php?id_outlet=<?=$dt_outlet['id_outlet']?>" class="btn btn-success">Ubah<a> 
                    ...
                    <a href="../member/histori_owner.php?id_outlet=<?=$dt_outlet['id_outlet']?>" 
                    class="btn btn-primary">Histori</a></td>
            </tr>
        <?php
        }
    // }
